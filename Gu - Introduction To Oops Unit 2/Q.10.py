...
# The screen resolution of the laptop is a string and can contain any printable ASCII characters.Design a Python program that uses hierarchical inheritance to model electronic devices. There are two types of electronic devices: Mobiles and Laptops. Both Mobiles and Laptops have a brand name and a price. However, a Mobile also has a screen size, while a Laptop has a screen resolution.
